            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-start flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link" href="contestant.php">Models</a>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link" href="form.php">Become A Model</a>
                </li>
                <li class="nav-item">
  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        <h1 class="section-title text-center mt-4" data-aos="fade-up">Our Models</h1>
          ...
          <div class="swiper-wrapper d-flex border-animation-left">
            ...
            <?php
              ...
              <div class='banner-item image-zoom-effect'>
                <div class='image-holder'>
                  <a href='#'>
                    <img src=admin/".$row['pic']." alt='product' class='img-fluid'>
                  </a>
                </div>
                <div class='banner-content py-4'>
                  <h5 class='element-title text-uppercase'>
                    <a href='index.html'>Name - ".$row['full_name']."</a>
                  </h5>
                  <p class='element-title'>
                    <a href='index.html'>Nickname - ".$row['username']."</a>
                  </p>
                  <p class='element-title'>
                    <a href='index.html'>Total Votes - ".$row['votes']."</a>
                  </p>
                  <div class='btn-left'>
            ...
            <!-- <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor">Mileena Skywalker</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Vote Now</a>
                  </div>
                </div>
              </div>
            </div> -->
            <!-- <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor">Hannah Milton</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Vote Now</a>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor">Ember Moon</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Vote Now</a>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor">Damian Gray</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Vote Now</a>
            ...
            <div class="swiper-slide">
              <div class="banner-item image-zoom-effect">
                ...
                <div class="banner-content py-4">
                  <h5 class="element-title text-uppercase">
                    <a href="index.html" class="item-anchor">Alita O'Conor</a>
                  </h5>
                  <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                  <div class="btn-left">
                    <a href="#" class="btn-link fs-6 text-uppercase item-anchor text-decoration-none">Vote Now</a>
