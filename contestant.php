...
<body class="homepage">
  ...
  <section class="my-5 p-5">
    <h2 class="text-center pb-4">ALL MODELS</h2>
  ...
  <table class="table table-responsive">
    ...
    <?php
        $sql = mysqli_query($conn,"SELECT * FROM model_tbl");
        ...
        while($result = mysqli_fetch_assoc($sql)){
            ...
            <tr style="vertical-align: middle;">
                <td><a href="vote_contestant.php?id='.$result['id'].'"><img src='. $result["pic"]. ' class="img-fluid rounded-circle" width="50" /></a></td>
                <td>'.$i.'</td>
